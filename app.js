...
function getMovie() {
  ...
  if (movieName.length <= 0) {
    message.innerHTML = `<h3>Enter name of movie</h3>`;
  } else {
    fetch(url)
      .then((resp) => resp.json())
      .then((data) => {
        ...
        if (data.Response == "True") {
          container.innerHTML = `<div class="search">
                <input type="text" id="search__field" placeholder="Movie name" class="search__field">
            ...
            <div class="movie__infoBox">
                ...
                <div class="movie__info">
                    ...
                    <span class="movie__rating"><img src="star-icon.svg">${
                      data.imdbRating
                    } / 10</span>
                    <span class="movie__details">${data.Rated} | ${
            data.Year
          } | ${data.Runtime}</span>
